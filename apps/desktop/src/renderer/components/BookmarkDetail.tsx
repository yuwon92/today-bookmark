    ...
    <div className="pixel-detail-overlay">
      ...
      <div className="pixel-detail-section" style={{ background: 'var(--win)', textAlign: 'center', padding: '12px 10px' }}>
        {bookmark.thumbnail ? (
          <img
            ...
            alt=""
            style={{ width: '100%', maxHeight: 120, objectFit: 'cover', border: '1px solid var(--border)' }}
          ...
          <img
            src={favicon}
            alt=""
            style={{ width: 48, height: 48, border: '1px solid var(--border)', background: 'var(--inactive)', padding: 8 }}
            onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }}
          />
        )}
      </div>
          ...
          {tags.map((tag) => (
            <span
              ...
              style={{
                ...
                padding: '0 4px', fontSize: 9, lineHeight: '16px',
              }}
            >
              #{tag}
              <button
                ...
                style={{
                  ...
                  padding: 0, fontSize: 9, color: '#4A425F', lineHeight: 1,
                }}
              >
                ✕
              </button>
      ...
      <div className="pixel-detail-section">
        ...
        <textarea
          ...
          rows={4}
          style={{ fontSize: 11, resize: 'none', height: 'auto' }}
        />
      </div>
