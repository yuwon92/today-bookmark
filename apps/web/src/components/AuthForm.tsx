  ...
  return (
    <div style={{ padding: 20, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', marginBottom: 16 }}>
        <div style={{ fontWeight: 'bold', fontSize: 13 }}>Today Bookmark</div>
        <div style={{ fontSize: 10, color: '#8C80A8', marginTop: 2 }}>북마크 관리</div>
      </div>
      ...
      <form onSubmit={submit}>
        <div className="pixel-panel">
          ...
          <div className="pixel-row">
            ...
            <input
              ...
              required className="pixel-input" placeholder="user@example.com"
            />
          </div>
          <div className="pixel-row">
            ...
            <input
              ...
              required minLength={6} className="pixel-input" placeholder="••••••"
            />
          </div>
          {error && (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <button
            type="button" className="pixel-btn" style={{ fontSize: 10, padding: '3px 8px' }}
